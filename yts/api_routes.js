...
module.exports = (function() {
	...
	router.get(`/:channel/watched/:index`, (req, res) => {
		...
		cp.exec(`./yts/.watched.bash ${req.params.channel} ${req.params.index}`, (err, stdout, stderr) => { console.log(stdout);
			if (err) throw err;
	...
	router.get(`/:channel/active/:index`, (req, res) => {
		...
		cp.exec(`./yts/.active.bash ${req.params.channel} ${req.params.index}`, (err, stdout, stderr) => { console.log(stdout);
			if (err) throw err;
